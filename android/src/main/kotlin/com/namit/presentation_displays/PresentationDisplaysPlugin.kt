...
class PresentationDisplaysPlugin : FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler {
    ...
    private fun handleShowPresentation(arguments: Any?, result: MethodChannel.Result) {
        try {
            val argsMap = arguments as? Map<*, *>
                ?: throw IllegalArgumentException("Invalid argument type: ${arguments?.javaClass?.name}")
            val displayId = argsMap["displayId"] as? Int ?: 0
            val routerName = argsMap["routerName"] as? String ?: "/"
